        ...
        <!-- <div class="animate form login_form"> -->
          <section class="login_content">
            <form method="POST" action="<?=site_url('auth/validate/')?>">
              <h1>Login Form</h1>
              <div>
                <input type="text" name="username" id="username" class="form-control" placeholder="Username" required="" value="<?=$this->session->flashdata('username')?>">
              </div>
              <div>
                <input type="password" name="password" class="form-control" placeholder="Password" required="" pattern=".{3,50}" />
              </div>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><img src="<?=base_url('assets/img/logo_icon.png')?>" alt="logo" height="15%" width="15%"> Indonesia Comnet Plus</h1>
