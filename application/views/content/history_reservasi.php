...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li class="active"><a href="#">History Reservasi</a></li>
    </ol>
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <table id="table-reservasi" class="table table-bordered text-center display">
              <thead>
                <tr>
                  <th width="50">No</th>
                  <th>Jumlah</th>
...
<div id="modal-form-reservasi" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form action="<?= site_url('reservasi/save/') ?>" id="form-reservasi" method="POST" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Form History Reservasi</h4>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <input type="hidden" name="id" id="id" />
            <label for="number">History Reservasi Number</label>
            <input type="text" class="form-control" name="number" id="number" />
          </div>
          <div class="form-group">
            <label for="reservasi">History Reservasi Name</label>
...
<div id="modal-delete-reservasi" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <form action="<?= site_url('reservasi/delete/') ?>" id="form-reservasi" method="POST">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Hapus History Reservasi</h4>
        </div>
        <div class="modal-body">
...
<script type="text/javascript">
  ...
  function show_delete(id) {
    ...
    $('#modal-delete-reservasi').modal('show')
  }
</script>